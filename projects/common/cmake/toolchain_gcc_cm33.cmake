...
if(NOT DEFINED USE_DEFAULT_PATH)
  set(USE_DEFAULT_PATH TRUE)
endif()
if(WIN32)
  set(DEFAULT_SIMPLICITY_DEV_DIR "C:/SiliconLabs/SimplicityStudio/v5/developer")
elseif(APPLE)
  set(DEFAULT_SIMPLICITY_DEV_DIR "/Applications/Simplicity Studio.app/Contents/Eclipse/developer")
else()
  set(DEFAULT_SIMPLICITY_DEV_DIR "/opt/SimplicityStudio_v5/developer")
endif()

if(DEFINED ENV{ARM_GCC_DIR})
  set(TOOLCHAIN_DIR "$ENV{ARM_GCC_DIR}/bin/")
elseif(USE_DEFAULT_PATH)
  set(TOOLCHAIN_DIR "${DEFAULT_SIMPLICITY_DEV_DIR}/toolchains/gnu_arm/12.2.rel1_2023.7/bin/")
endif()

if(DEFINED ENV{POST_BUILD_EXE})
  set(POST_BUILD_EXE "$ENV{POST_BUILD_EXE}")
elseif(USE_DEFAULT_PATH)
  set(POST_BUILD_EXE "${DEFAULT_SIMPLICITY_DEV_DIR}/adapter_packs/commander/commander${EXE_SUFFIX}")
endif()

if(DEFINED ENV{NINJA_EXE_PATH})
  set(NINJA_RUNTIME_PATH "$ENV{NINJA_EXE_PATH}")
elseif(USE_DEFAULT_PATH)
  set(NINJA_RUNTIME_PATH "${DEFAULT_SIMPLICITY_DEV_DIR}/adapter_packs/ninja/ninja${EXE_SUFFIX}")
endif()

if (CMAKE_GENERATOR MATCHES "Ninja" AND NINJA_RUNTIME_PATH)
  set(CMAKE_MAKE_PROGRAM ${NINJA_RUNTIME_PATH} CACHE FILEPATH "" FORCE)
# ELSE: Do nothing, use the default make program
endif()
